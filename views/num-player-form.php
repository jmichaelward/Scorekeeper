<?php if (!isset($_SESSION['num-players'])) : ?>
    ...
    <form action="index.php" method="post" id="player-form">
        <ul>
            ...
            <li>
                <button id="num-players-button">Click to start</button>
            </li>
        </ul>
    </form>
<?php else : ?>
    ...
    <form action="index.php" method="post" id="player-list-form">
